...
def novoArquivo():
    ...
    tamanho_original = Label(framecima, text="Altura e Largura Original " + str(img_altura) + "x" + str(img_largura), width=22, height=1, pady=7, padx=10, relief="flat", anchor=CENTER, font=('Courier  12 bold'), bg=co2, fg=co3)
    tamanho_original.grid(row=2, column=0, columnspan=2, sticky=NSEW, pady=5)
...
# Função para converter
    ...
    nova_altura = Label(framecima, text="Digite nova altura", width=10, height=1, pady=7, padx=10, relief="flat", anchor=CENTER, font=('Courier  9 bold'), bg=co2, fg=co0)
    ...
    # Botão Converter
    b_converter = Button(framecima, text="Converter", width=10, height=1, bg=co5, fg="white", font="5", anchor="center", relief=RAISED, command=converter)
    b_converter.grid(row=5, column=0, columnspan=2,  pady=5)

# Criar botão para o novo arquivo
b_novo = Button(framecima, text="+ Novo", width=10, height=1, bg=co3, fg="white", font="5", anchor="center", relief=RAISED, command=novoArquivo)
